...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Flutter Demo1 Home Page'),
      // home: MySecondPage(title: 'Flutter Demo2 Home Page'),
      // home: MyThirdPage(title: 'Flutter Demo3 Home Page'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MySecondPage(title: 'Flutter Demo2 Home Page')),
    );
  }
